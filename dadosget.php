...
//echo "Nome:" . $_GET['nome']. " Sobrenome: ". $_GET['email'] ."  <br> <br>";
...
Em questões de eficiência, não há ganho para o PHP ao acessar uma variável ou outra (POST ou REQUEST),
...
Por padrão obedece a sequencia EGPCS (Environment, Get, Post, Cookie, e Server).
